...
FOLDER_NAME = 'wall_aware_hybrid3_recovery_v3_5_a'
...
CONNECTIVITY_FEATURE_DIM = 10
INPUT_DIM = 6 + CONNECTIVITY_FEATURE_DIM
EMBEDDING_DIM = 128
POLICY_LR = 1e-6
Q_LR = 1e-5
...
WEAK_SIGNAL_PENALTY_WEIGHT=0.20
COMPONENT_DEFICIT_PENALTY_WEIGHT=0.50
DISCONNECT_DURATION_PENALTY_WEIGHT=0.25
NEW_DISCONNECT_PENALTY_WEIGHT=0.20
